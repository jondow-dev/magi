...
bool CheckBlock(const CBlock& block, BlockValidationState& state, const Consensus::Params& consensusParams, CBlockIndex* pindex = nullptr, bool fCheckPOW = true, bool fCheckMerkleRoot = true, bool fCheckSignature = true);
